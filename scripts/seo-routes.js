...
export const seoRoutes = [
  ...
  page("/about/bhaskara-rao", "Bhaskara Rao Arani | Java, FinTech and Software Architect", "Meet Bhaskara Rao Arani, CTO and software engineering leader specializing in Java, Spring Boot, payments, microservices, Kafka, cloud, observability, and AI systems.", { priority: "0.8", type: "profile" }),
  ...
  page("/blog/idempotent-payment-apis-prevent-duplicate-charges", "Idempotent Payment APIs: Prevent Duplicate Charges | ARIN IT", "Design reliable payment APIs using idempotency keys, atomic writes, safe retries, Kafka deduplication, outbox events, recovery, and reconciliation.", { type: "article", priority: "0.8", publishedTime: "2026-09-16" }),
  ...
  page("/industries/fintech", "FinTech Software Engineering Company | ARIN IT Solutions", "Build resilient payment, banking, wallet, reconciliation, lending, and financial operations platforms with experienced FinTech engineers.", { priority: "0.9" }),
  page("/solutions/payment-reconciliation", "Payment Reconciliation Software Solutions | ARIN IT", "Design automated payment reconciliation, settlement matching, exception management, audit trails, and operational reporting for FinTech platforms.", { priority: "0.9" }),
  page("/solutions/api-integration", "Enterprise API Integration Services | ARIN IT Solutions", "Connect enterprise, payment, SaaS, and legacy platforms through secure APIs, events, webhooks, adapters, and observable integration workflows.", { priority: "0.9" }),
  page("/solutions/platform-engineering", "Platform Engineering Services | ARIN IT Solutions", "Improve developer delivery with secure internal platforms, golden paths, CI/CD, Kubernetes, observability, and self-service infrastructure.", { priority: "0.9" }),
  page("/technologies/spring-boot", "Spring Boot Development and Consulting | ARIN IT", "Build secure enterprise APIs and microservices with Java, Spring Boot, Spring Security, data access, testing, observability, and cloud deployment.", { priority: "0.8" }),
  page("/technologies/kafka", "Apache Kafka Consulting and Event-Driven Architecture | ARIN IT", "Design reliable Kafka platforms with event contracts, partitioning, consumer groups, idempotency, retries, schema evolution, and observability.", { priority: "0.8" }),
  page("/technologies/kubernetes", "Kubernetes Consulting and Cloud-Native Platforms | ARIN IT", "Run secure, observable and resilient applications on Kubernetes with workload design, autoscaling, deployment automation, policy, and recovery.", { priority: "0.8" }),
  page("/locations/software-development-company-hyderabad", "Software Development Company in Hyderabad | ARIN IT", "Work with a Hyderabad software development company for enterprise applications, Java microservices, cloud platforms, web products, and modernization.", { priority: "0.9", areaServed: "Hyderabad, Telangana, India", serviceType: "Custom software development" }),
  page("/locations/fintech-development-company-india", "FinTech Development Company in India | ARIN IT Solutions", "Build payment, reconciliation, wallet, merchant, banking integration, and financial operations software with an experienced FinTech development company in India.", { priority: "0.9", areaServed: "India", serviceType: "FinTech software development" }),
  page("/locations/java-consulting-services-hyderabad", "Java Consulting Services in Hyderabad | ARIN IT Solutions", "Get Java consulting in Hyderabad for Spring Boot architecture, microservices, Kafka, performance, modernization, cloud deployment, and production reliability.", { priority: "0.9", areaServed: "Hyderabad, Telangana, India", serviceType: "Java consulting" }),
