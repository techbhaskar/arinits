    ...
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto mb-16 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Talented professionals dedicated to delivering exceptional technology
          solutions. We combine expertise, creativity, and passion to bring your
          vision to life.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto mb-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="glass-strong rounded-2xl p-6 text-center shadow-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member) => (
            ...
            >
              ...
              {/* Member Info */}
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2 group-hover:text-arin-orange transition-colors">
                  {member.name}
                </h3>
                ...
                <div className="flex gap-3">
                  {member.social.linkedin && (
                    <a
                      ...
                      className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 hover:bg-arin-orange hover:text-white transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
